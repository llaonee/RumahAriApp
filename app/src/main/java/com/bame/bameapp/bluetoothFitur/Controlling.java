package com.bame.bameapp.bluetoothFitur;
...
public class Controlling extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDevice = b.getParcelable(MainActivityBluetooth.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(MainActivityBluetooth.DEVICE_UUID));
        mMaxChars = b.getInt(MainActivityBluetooth.BUFFER_SIZE);
